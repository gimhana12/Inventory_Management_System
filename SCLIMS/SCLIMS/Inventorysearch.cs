...
namespace SCLIMS
{
    public partial class Inventorysearch : Form
    {
        ...
        public void searchData(string valueToFind)
        {
            try
            {
                string searchQuery = "SELECT items_transfer_external.location, items.item_name FROM items LEFT JOIN items_transfer_external ON items.item_code = items_transfer_external.item_code \r\nLEFT JOIN items_transfer_internal ON items.item_code = items_transfer_internal.item_code \r\nWHERE items.item_code LIKE @valueToFind OR items.item_name LIKE @valueToFind;\r\n";
